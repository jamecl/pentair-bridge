...
- ESP32 (MAC: `68:25:dd:49:1d:18`, reserved IP: `192.168.0.30`)
- RS-485 transceiver module connected to UART2 (TX=17, RX=16, RTS=4)
- 5V power supply (the original failed due to a power surge — replaced)
